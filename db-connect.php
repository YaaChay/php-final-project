...
//     . $earliestQuery = "CREATE TABLE IF NOT EXISTS `orders`(`id` INT UNSIGNED NOT NULL AUTO_INCREMENT, `acc_name` VARCHAR(25) NOT NULL, `book_id` INT UNSIGNED NOT NULL, `product_key` VARCHAR(10) NOT NULL, `count` INT NOT NULL, `date` VARCHAR(20) NOT NULL, `total_price` INT NOT NULL, `status` VARCHAR(5) DEFAULT 'step1',PRIMARY KEY(`id`),FOREIGN KEY(`acc_id`));"
//     . $earliestQuery = "CREATE TABLE IF NOT EXISTS `orders` (`id`INT UNSIGNED NOT NULL AUTO_INCREMENT, `cus_name` VARCHAR(25) NOT NULL, `cus_address` VARCHAR(120) NOT NULL, `phone` VARCHAR(15) NOT NULL,`email` VARCHAR(30) NOT NULL, `book_name` VARCHAR(100) NOT NULL, `product_key` VARCHAR(10) NOT NULL, `price` INT NOT NULL, `count` INT NOT NULL, `total` INT NOT NULL, `order_date` VARCHAR(12) NOT NULL, `status` INT DEFAULT 1, PRIMARY KEY(`id`));";
