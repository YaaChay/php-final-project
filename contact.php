                ...
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        <div class="control-group">
                            <input type="text" class="form-control" id="name" placeholder="<?php echo $dataDecode[$_COOKIE['lang']]['your_name'];?>"
                                required="required" data-validation-required-message="Please enter your name" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="email" class="form-control" id="email" placeholder="<?php echo $dataDecode[$_COOKIE['lang']]['your_email'];?>"
                                required="required" data-validation-required-message="Please enter your email" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" placeholder="<?php echo $dataDecode[$_COOKIE['lang']]['subject'];?>"
                                required="required" data-validation-required-message="Please enter a subject" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <textarea class="form-control" rows="8" id="message" placeholder="<?php echo $dataDecode[$_COOKIE['lang']]['message'];?>"
                                required="required"
            ...
            <div class="col-lg-5 mb-5">
                <div class="bg-light p-30 mb-30">
                    <iframe style="width: 100%; height: 250px;"
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d29967.41425335095!2d92.883289!3d20.137102!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9a8d65db08e2c9a7!2z4YCF4YCF4YC64YCQ4YC94YCx4YCA4YC94YCU4YC64YCV4YC74YCw4YCQ4YCs4YCQ4YCA4YC54YCA4YCe4YCt4YCv4YCc4YC6!5e0!3m2!1smy!2sus!4v1675188925568!5m2!1smy!2sus"
