                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                        <div class="row">
                            ...
                            <div class="col-md-12 control-group">
                                ...
                                <textarea class="form-control" rows="6" id="message" placeholder="" required="required" data-validation-required-message=""></textarea>
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="col-md-6 form-group">
                                <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton"><?php echo $dataDecode[$_COOKIE['lang']]['create']; ?></button>
                            </div>
                        </div>
                    </form>
                </div>
